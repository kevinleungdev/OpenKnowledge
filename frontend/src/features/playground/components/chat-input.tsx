  ...
  return (
    <div className='flex flex-row items-center gap-2 rounded-3xl bg-muted px-4 py-3 wrap-break-word'>
      <Textarea
        ...
        className='min-h-7 max-h-50 w-full resize-none border-0 bg-transparent p-0 text-foreground shadow-none outline-none focus-visible:border-0 focus-visible:ring-0 placeholder:text-muted-foreground dark:bg-transparent md:text-base'
        rows={1}
      />
